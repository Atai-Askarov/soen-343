  ...
  return (
    <div>
      <div className="scrollImage">
        <img
          className="image"
          src="https://puzzlemania-154aa.kxcdn.com/products/2024/puzzle-enjoy-1000-pieces-montreal-skyline-by-night-canada.webp"
          alt="placeholder"
        />
      </div>
      <div className="home-image-text">
        <p className="home-image-text-subtitle">Welcome to SEES</p>
        <p className="home-image-text-subtitle">
              ...
              {events.length > 0 ? (
                events.map((event) => (
                  <div
                    ...
                    style={{
                      backgroundImage: `url(${event.event_img || "/images/default.jpg"})`,
                    }}
                  >
                    <Link
                      to={`/eventpage/${event.eventid}`}
                    ...
                    >
                      ...
                      >
                        ...
                        {event.speakerid
                          ? `With Special Guest ${event.speakerid}`
                          : "TBA"}
                      </p>
                    </Link>
                  </div>
